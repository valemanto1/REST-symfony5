 ...
 */
final class Version20200816152912 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE competition_id competition_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE competition_id competition_id INT DEFAULT NULL');
    }
}
